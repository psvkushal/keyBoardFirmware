...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|---------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                          OSM(MOD_LCTL),   OSL(NUMBER),  KC_SPC,     KC_ENT,   OSL(UTILS), OSM(MOD_LGUI)
                                      //`--------------------------'  `--------------------------'
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      KC_TILD,  KC_EQL, KC_PPLS, KC_LCBR, KC_LPRN, KC_LBRC,                      KC_LT, OSM(MOD_RGUI),   OSM(MOD_RALT),OSM(MOD_RCTL), OSM(MOD_RSFT), QK_LOCK,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      QK_LOCK, OSM(MOD_LSFT), OSM(MOD_LCTL), OSM(MOD_LALT), OSM(MOD_LGUI), _______,                      KC_LEFT,  KC_UP, KC_DOWN, KC_UP, KC_MPLY,  _______,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
